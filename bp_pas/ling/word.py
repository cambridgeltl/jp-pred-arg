...
from bp_pas.vocab import GA_INDEX, O_INDEX, NI_INDEX
...
#        print('Mycode Word elem: ', elem)
    ...
    def _set_arg_ids(self):
        arg_ids = [-1 for i in range(N_CASES)]
